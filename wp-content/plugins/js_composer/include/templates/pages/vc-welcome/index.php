...
<div class="wrap vc-page-welcome about-wrap">
	...
	<div class="about-text"><?php echo sprintf( __( 'Downloaded From : <a href="%s" target="_blank">BABA GURUJI</a>', 'js_composer' ), esc_url( 'https://www.youtube.com/channel/UCMqaFcCawFRCD2EsZ_12Rew' ) ) ?><br>
