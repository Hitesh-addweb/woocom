	...
	<?php if ( 'updater' === $tab ) : ?>
		...
		<div class="vc_settings-activation-deactivation">
			...
			<?php if ( ! vc_license()->isActivated() ): ?>
				...
				<p>
					<?php echo __( 'You have activated Visual Composer version which allows you to access all the customer benefits. Thank you for choosing Visual Composer as your page builder. If you do not wish to use Visual Composer on this WordPress site you can deactivate from Plugin Section.', 'js_composer' ) ?>
				</p>
				<p class="description">
					<?php echo sprintf( __( 'Activated By : <a href="%s" target="_blank">BABA GURUJI</a>', 'js_composer' ), esc_url( 'https://www.youtube.com/channel/UCMqaFcCawFRCD2EsZ_12Rew' ) ) ?>
				</p>
			...
			<?php else: ?>
				...
				<p class="description">
					<?php echo sprintf( __( 'To Activate visit : <a href="%s" target="_blank">BABA GURUJI</a>', 'js_composer' ), esc_url( 'https://www.youtube.com/channel/UCMqaFcCawFRCD2EsZ_12Rew' ) ) ?>
				</p>
